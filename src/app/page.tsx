...
export default function Home() {
  ...
  // For the replica demo, we'll show a landing with access to both roles.
  
  return (
    <Shell userRole="seller">
      <PageHeader 
        title="Welcome to Musaa OrderFlow" 
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <Button asChild className="w-full bg-primary hover:bg-slate-800 text-white gap-2">
              <Link href="/dashboard">
        ...
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <Button asChild variant="outline" className="w-full border-slate-200 gap-2">
              <Link href="/shop">
